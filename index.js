  ...
  card.innerHTML = `
    <div class="card shadow-sm">
      ...
      <div class="card-body">
          ...
          <button class="btn btn-sm btn-success" onclick="openEditBookModal('${book.id}')">Edit</button>
          <button class="btn btn-sm ${book.favorite ? "btn-success" : "btn-outline-success"}" onclick="toggleFavorite('${book.id}')">
